...
const FName ADrivingSimulatorPawn::EngineAudioRPM("RPM");
...
void ADrivingSimulatorPawn::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &ADrivingSimulatorPawn::OnResetVR); 
}
...
void ADrivingSimulatorPawn::EnableIncarView(const bool bState)
{
...
void ADrivingSimulatorPawn::UpdatePhysicsMaterial()
{
